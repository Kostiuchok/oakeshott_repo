...
$x=row_id(morskoe_strahovanie_doc_1,$id);
?>
<!-- Grid row -->
				<div class="row">
					...
					<article class="span12 data-block">
						<div class="data-container" >
							<header>
								<h2><span class="awe-star"></span> Морское страхование - ПЕРЕЧЕНЬ ОСНОВНЫХ ОПРОСНИКОВ</h2>
...
<form action="router.php" method="POST" name="" enctype="multipart/form-data">
	...
	<div class="control-group">
		...
		<div class="form-actions">
			     <button class="btn btn-alt btn-large btn-success" type="submit" name="morskoe_strahovanie_doc_1_edit">
	...
	<!-- ***************************************** Content ************************************************* -->
				...
				<div class="alert alert-inverse">
					...
					<strong> ПЕРЕЧЕНЬ ОСНОВНЫХ ОПРОСНИКОВ </strong> - редактирование информации
				</div>
