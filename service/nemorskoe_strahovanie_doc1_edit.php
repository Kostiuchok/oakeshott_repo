...
$x=row_id(nemorskoe_strahovanie_doc1,$id);
?>
<!-- Grid row -->
				<div class="row">
					...
					<article class="span12 data-block">
						<div class="data-container" >
							<header>
								<h2><span class="awe-star"></span> Базовые условия страхование неморских рисков</h2>
...
<label class="control-label" style="margin-left: 15px;"> Размер файла : 
		...
		<div class="form-actions">
			     <button class="btn btn-alt btn-large btn-success" type="submit" name="nemorskoe_strahovanie_doc1_edit">
