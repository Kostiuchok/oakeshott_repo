				...
				<div class="row">
					...
					<article class="span12 data-block">
						<div class="data-container" >
							<header>
								<h2><span class="awe-star"></span> Виды деятельности - Нестандартные и новые продукты</h2>
...
<form action="router.php" method="POST" name="" enctype="multipart/form-data">
	<fieldset>
		...
		<div class="form-actions">
			<button class="btn btn-alt btn-large btn-success" type="submit" name="nestandartnoe"> Обновить информацию в базе</button>
		</div>	
	...
	<!-- ***************************************** Content ************************************************* -->
				...
				<div class="alert alert-inverse">
					...
					<strong> Виды деятельности </strong> - Нестандартные и новые продукты
				</div>
