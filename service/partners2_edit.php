				...
				<div class="row">
					...
					<article class="span12 data-block">
						<div class="data-container" >
							<header>
								<h2><span class="awe-star"></span> Члентсво - редактирование информации</h2>
...
<strong> Члентсво </strong> - редактирование информации.
</div>
<form action="router.php" method="POST" name="" enctype="multipart/form-data">
	<fieldset>
		...
		<div class="form-actions">
			<button class="btn btn-alt btn-large btn-success" type="submit" name="partners_edit_2"> Обновить информацию в базе </button>
		</div>
